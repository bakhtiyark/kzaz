...
})(
  {
    1: [
      function (e, t, n) {
        ...
        function o() {
          for (
            var e, o, i = "__tcfapiLocator", r = [], a = window, t = a;
            t;
    ...
    4: [
      function (e, t, n) {
        t.exports = {
          ...
          cmpId: "162",
          cmpVersion: "1",
          cookieInformationIABCdnUrl:
            "https://cookieinformation.mgr.consensu.org",
          cookieInformationTCFCdnUrl:
          ...
          (function (i) {
                ...
                if (window.CookieInformation.getConsentGivenFor(e))
                  ...
                  for (
                    ...
                    c[u].getAttribute("data-consent-src") &&
                      ...
                      a.setAttribute(
                        "class",
                        n + " cookieinformation-yt-element"
                      ),
            ...
            function j() {
              for (
                ...
                if (e[n].getAttribute("src")) {
                  if (
                    -1 !==
                      (t = e[n].getAttribute("src").toLowerCase()).indexOf(
                        "/uc.js"
                      ) &&
            ...
            function W(e, t, n) {
              if (
                ...
                return (
                  document.getElementsByTagName("body")[0].appendChild(t), !0
                );
              1e3 < ++l
            ...
            function J() {
              ...
              (t.type = "text/javascript"),
                ...
                R(r)
                  ? (we("2"),
                    W("__tcfapiLocator", t, "CookieInformationCmpIframe"))
                  : Z()
            ...
            function Ce(e) {
              return (
                !!e && "Invalid Date" !== new Date(e) && !isNaN(new Date(e))
              );
            }
            function ve(e) {
            ...
            function _e(e, t) {
              ...
              e = new Date(e);
              return (
                e.setTime(e.getTime() + 24 * t * 60 * 60 * 1e3), e.toUTCString()
              );
            }
            ...
            function Ie() {
              ...
              var e =
                  window.cookieInformationCustomConfig.hasOwnProperty(
                    "acceptFrequency"
                  ),
                t =
                  window.cookieInformationCustomConfig.hasOwnProperty(
            ...
            function Ae(e, t, n, o, i) {
              ...
              if (t && !e)
                ...
                if (void 0 === e.website_uuid) {
                  e.website_uuid = n || "";
                  t = Ee(e.consents_approved, window.cicl);
                  Le(i, e, _e(e.timestamp, t), y, g), xe(h, e);
                } else if (he(n, e))
                  ae(h, ie(location.host)),
                    ae(h, "." + location.host),
                    ae(h),
              ...
              if (e.origin === a.cdnUrl) {
                ...
                if ("GET" === e.data.type) {
                  try {
                    ...
                    console.log(
                      "There was an error in parsing cookie value",
                      e
                    );
                  }
                  ...
                  "SAVE" === e.data.type ||
                    "DELETE" === e.data.type ||
                    ("GET_COOKIE_CONTROL" === e.data.type &&
                      N(e.data.cookieConsent, !0));
              }
            }
            function je() {
            ...
            d &&
              ...
              Object.defineProperty(d.prototype, "lastElementChild", {
                get: function () {
                  for (
                    var e, t = this.childNodes, n = t.length - 1;
                    (e = t[n--]);
            ...
            var Re = {
              ...
              sendConsent: function (e) {
                var t = {},
                  n =
                    a.mainEndpoint + a.apiPrefix + a.consentAcceptanceEndpoint;
              ...
              submitConsent: function (e) {
                ...
                Z() &&
                  ((t = r),
                  (n = Y(
                    window.CookieInformation.cmp.IABlanguagesCodesMapping
                  )),
                  (o =
                    window.CookieInformation.cmp.getAllowedPurposesFromConsentCookie()),
                  (i =
                    window.CookieInformation.cmp.getAllowedVendorsFromConsentCookie()),
                  document.getElementById("coiConsentBannerIABColumn") &&
                    -1 !==
                      t.consents_approved.indexOf("cookie_cat_marketing") &&
                    ((i = (t =
                      window.CookieInformation.cmp.getIABConsent()).vendorList.vendors.map(
                      function (e) {
                        return e.id;
                      }
                    )),
